...
<template>
  <button
    class="flex items-center justify-center gap-2 bg-[rgba(153,153,191,.2)] backdrop-blur-xl text-white text-[16px] min-w-[52px] min-h-[52px] ml-[12px] p-[14px] rounded-[8px] cursor-pointer transition-colors duration-300 hover:bg-[rgba(153,153,191,.3)]"
  >
    ...
    <span v-if="text" class="font-bold">{{ text }}</span>
  </button>
</template>
