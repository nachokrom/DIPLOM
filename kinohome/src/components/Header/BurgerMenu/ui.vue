  ...
  <transition name="slide" class="bg-[#292929]">
    <div class="burger_block" v-show="mobileMenuOpen" @click.self="mobileMenuOpen = false">
      <div class="burger_items py-10">
        ...
        <nav class="py-0">
          <router-link to="/" class="block px-5 py-2 rounded hover:bg-blue-700"
            >Главная</router-link
          >
          <router-link to="/movies" class="block px-5 py-2 rounded hover:bg-blue-700"
            >Фильмы</router-link
          >
          <router-link to="/serials" class="block px-5 py-2 rounded hover:bg-blue-700"
            >Сериалы</router-link
          >
          <router-link to="/cartoons" class="block px-5 py-2 rounded hover:bg-blue-700"
