    ...
    <main class="main-back pt-32 pb-32">
        <div class="flex items-center justify-center">
            <div class="w-96 shadow-2xl rounded-xl p-10 bg-[#222222]">
                ...
                <div>
                    <input class="w-full px-4 py-2 bg-gray-600 text-white rounded" type="email" placeholder="Email">
                </div>
                <div>
                    <input class="w-full px-4 py-2 mb-2 bg-gray-600 text-white rounded" type="password" placeholder="Пароль">
                </div>
                <div>
                    <input class="w-full px-4 py-2 mb-2 bg-gray-600 text-white rounded" type="password" placeholder="Повторите пароль">
                </div>
